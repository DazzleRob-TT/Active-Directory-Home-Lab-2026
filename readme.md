...
15.After the installation is completed select promote this server to a domain controller.
...
8.Within the shared folder I created a folder named “Admin Department”
